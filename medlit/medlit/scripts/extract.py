...
from medlit.bundle_models import (
    AuthorInfo,
    EvidenceEntityRow,
    ExtractedEntityRow,
    PaperInfo,
...
# Use repo root relative to this file for git info
...
async def _paper_content_from_parser(raw_content: bytes, content_type: str, source_uri: str) -> tuple[str, Optional[PaperInfo]]:
    ...
    from medlit.pipeline.parser import JournalArticleParser
...
async def run_extract(  # pylint: disable=too-many-statements
    ...
    import medlit.domain_spec as _ds
    ...
    for _, path in enumerate(files):
        ...
        from medlit.pipeline.provenance_expansion import expand_provenance
